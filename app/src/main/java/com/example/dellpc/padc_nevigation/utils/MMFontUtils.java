package com.example.dellpc.padc_nevigation.utils;
...
import com.example.dellpc.padc_nevigation.PADC_Nevigation_App;
...
public class MMFontUtils {
    ...
    static {
        Context context = PADC_Nevigation_App.getContext();
